...
import { PUT_Productos as ModificarProductoRequest } from '../../../api'

class ProductosModificar extends Component {
    ...
    componentDidMount() {
        const { id, nombre, precio, descripcion, imagen } = this.props
        this.setState({
